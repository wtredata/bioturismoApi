...
insert into type_services (name,photo,description,active) values
                          ('Turismo Científico', 'turismoCientifico.jpg', 'Experiencias conectando la ciencia', 1),
                          ('Turismo Consciente', 'turismoAventura.jpg', 'Experiencias que te conectan con la vida y la naturaleza', 1),
                          ('Turismo Rural', 'turismoRural.jpg', 'Experiencias que conecta el pueblo', 1);
